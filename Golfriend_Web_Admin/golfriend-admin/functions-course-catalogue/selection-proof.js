...
for(const required of ['enforceAppCheck:true','REFRESH_SLO','verifyActivation','golf_api_quota_reservations','pageCacheId','clubOffset','courseOffset','withPageSize'])if(!source.includes(required))throw Error(`CONTROL_MISSING:${required}`);
