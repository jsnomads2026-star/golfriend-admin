...
const policySeedPreview = readFileSync(resolve(process.cwd(), 'src/economyPolicySeedPreview.ts'), 'utf8');
...
assert.doesNotMatch(policySeedPreview, /from ['\"]firebase|runTransaction|\.set\(|\.update\(|\.delete\(/i);
