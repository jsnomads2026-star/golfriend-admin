...
import {assertProviderGroupWithinLimit, catalogueProviderBatch, decodeCataloguePreviewCursor, encodeCataloguePreviewCursor, MAX_CATALOGUE_PREVIEW_GROUPS, parseCataloguePreviewRequest} from "./courseCataloguePreview.js";
...
const cursor = {version: 2 as const, afterProviderClubId: first.providerClubIds[first.providerClubIds.length - 1], afterCourseDocumentId: "course-24", readTimeSeconds: 1_789_123_456, readTimeNanoseconds: 123_456_789};
...
assert.doesNotThrow(() => assertProviderGroupWithinLimit(200, 200)); assert.throws(() => assertProviderGroupWithinLimit(201, 200), /PROVIDER_GROUP_TOO_LARGE/);
