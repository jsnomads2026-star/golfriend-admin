...
import {buildCuratedClubhouseRecord} from "./clubhouseAuthority.js";
...
const oldCourse = {clubHouseId: "siam-old-course", clubHouseName: "Siam Country Club Old Course", identityProvenance: "golfriend_founder_ruling", coordinateProvenance: "venue_official_map_link", latitude: 12.9179814, longitude: 100.9877539, providerClubId: "provider-umbrella", providerRelationship: "unresolved", providerSupplied: false, propertyHoleCount: 18, roundHoleCount: 18} as const;
