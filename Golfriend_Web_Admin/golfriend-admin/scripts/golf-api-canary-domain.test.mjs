...
const mixed={apiRequestsLeft:'3999.8',numAllClubs:42001,numClubs:3,pagination:{next:'/api/v2.3/clubs?page=2'},clubs:[
  {clubID:'club-a',name:'A',courses:[{courseID:'course-old'},{courseId:'course-new'}]},
  {name:'Malformed'},
  {golfClubId:'club-b',courses:[{name:'No identity'}]},
]};

test('quota metadata survives malformed records',()=>assert.deepEqual(extractProviderMetadata(mixed),{apiRequestsLeft:3999.8,numAllClubs:42001,numClubs:3,pagination:{next:'/api/v2.3/clubs?page=2'},topLevelFields:['apiRequestsLeft','clubs','numAllClubs','numClubs','pagination']}));
