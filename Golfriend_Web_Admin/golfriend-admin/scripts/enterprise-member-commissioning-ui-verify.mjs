...
const checks=[
 ...
 ['metadata-only proposal',ui.includes('metadataOnly')&&ui.includes('contentDigest')&&!ui.includes('customerApprovalRequired')&&!provider.includes('customerApprovalRequired')],
