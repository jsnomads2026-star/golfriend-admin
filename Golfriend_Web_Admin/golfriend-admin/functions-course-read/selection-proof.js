...
if (exportsFound.length !== 2 || !exportsFound.includes('getCourseCoverageByCountry') || !exportsFound.includes('planCourseCountryIngestion')) throw Error(`EXPORT_SELECTION_INVALID:${exportsFound.join(',')}`);
...
console.log('course-read selection proof PASS: staff-gated aggregate and Firebase-only plan, zero provider capability and zero course writes');
