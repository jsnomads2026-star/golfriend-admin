...
export type MobileBusinessPromotionV2={promotionId:string;locationIds:string[];contentDigest:string;disclosure:'sponsored_partner';effectiveAt:string;expiresAt:string};
export type MobileBusinessDetailProjectionV2=MobileProjectionEvidenceV2&{items:MobileBusinessCardV2[];promotions:MobileBusinessPromotionV2[];rawLocationPersisted:false;returnRoute:'/v2'};
