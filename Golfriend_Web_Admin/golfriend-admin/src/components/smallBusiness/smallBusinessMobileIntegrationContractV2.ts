...
export type MobileBusinessCardV2={businessId:string;profileVersion:number;profileDigest:string;locationId:string;locationVersion:number;displayName:string;category:string;city:string;country:string;description:string;availability:'known'|'unknown';partner:boolean;sponsored:boolean;disclosure:string;authoritativeStatus:'active';returnRoute:'/lounge'};
export type MobileBusinessProjectionV2=MobileProjectionEvidenceV2&{items:MobileBusinessCardV2[];nextCursor?:string;rawLocationPersisted:false;returnRoute:'/lounge'};
