export const PLAY_BOOKING_MESSAGE_DRAFT_TYPES:readonly ['request_received','alternative_proposed','booking_confirmed','booking_declined','booking_changed','booking_cancelled','booking_expired','tee_time_reminder','course_message'];
