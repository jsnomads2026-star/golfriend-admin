...
export interface OutreachDraft{kind:string;locale:string;subject:string;body:string;disclaimer:string;evidenceIncluded:boolean;recipientIncluded:boolean;deliveryAvailable:false;notice:string}
...
export function renderOutreachTemplate(input:{kind:string;locale:string;prospect:Record<string,unknown>;report?:OpportunityReport|null;includeRecipient?:boolean}):OutreachDraft;
