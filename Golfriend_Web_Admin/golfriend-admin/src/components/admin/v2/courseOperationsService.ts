...
export interface CourseOperationsService {
  ...
  enableWeeklyCourseRefresh():Promise<Record<string,unknown>>;
...
export const courseOperationsService: CourseOperationsService = {
  ...
  async enableWeeklyCourseRefresh(){return (await httpsCallable(functions,'enableWeeklyCourseRefresh')({})).data as Record<string,unknown>;},
