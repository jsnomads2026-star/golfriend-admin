...
export const firebaseEnterpriseMemberAdminProvider:EnterpriseMemberAdminProvider={
  list:(input)=>call('getEnterpriseMemberRequestsAdminV1',input), detail:(requestId)=>call('getEnterpriseMemberRequestAdminV1',{requestId}),
  ...
  prepareDelivery:(input)=>call('prepareEnterpriseMemberDeliveryAdminV1',input), outbox:(requestId)=>call('getEnterpriseMemberDeliveryOutboxAdminV1',{requestId}),
};
